...
nums111 = [i for i in range(1,60) if i%11 == 0]
result = list(map(add_five, nums111))

print(result)

замена функции на lambda

numers111 = [i for i in range(1,120) if i%11 == 0]
result = list(map(lambda x: x+5, numers111))
print(result)

функция filter

nums = [i for i in range(1,120) if i%11 == 0]
